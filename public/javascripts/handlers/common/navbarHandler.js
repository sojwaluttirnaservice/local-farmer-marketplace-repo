...
function setActiveLink() {
    ...
    links.forEach(link => {
        ...
        if (currentPath === linkPath) {
            ...
            link.classList.add('border-green-500', 'text-green-900');
            link.classList.remove('border-transparent', 'text-green-500');
            ...
            link.classList.add('border-transparent', 'text-green-500');
            link.classList.remove('border-green-500', 'text-green-900');
...
function addHoverEffect(event) {
    event.target.classList.add('hover:border-green-300', 'hover:text-green-700');
}

// Function to remove hover effect
function removeHoverEffect(event) {
    event.target.classList.remove('hover:border-green-300', 'hover:text-green-700');
}
